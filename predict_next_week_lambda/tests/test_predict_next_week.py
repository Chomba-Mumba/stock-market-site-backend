...
from predict_next_week_lambda.predict_next_week import lambda_handler, predict_multiple_steps, scale_data, unscale_data
...
def test_lambda_handler():
    ...
    mock_data = pd.DataFrame({"Date": [], "Date + 1": [], "Date + 5": []})
    ...
    event = {
        ...
        'multi_model_key': model_key,
        'pred_key': pred_key,
        'multi_local_path': model_path,
        'pred_path': pred_path
    }
    context = {}
